    ...
    Column(
        ...
        if (uiState.value.messages.isNotEmpty()) {
            ...
            LazyRow(
                ...
                itemsIndexed(
                    listOf(
                        "Як я можу заощаджувати більше грошей щомісяця?",
                        "Чи можете ви допомогти мені скласти план заощаджень?",
                        "Як уникнути імпульсивних покупок?",
                        "Як дотримуватися бюджету під час покупок?",
                        "Який найкращий спосіб заощадити на відпустку?",
                    )
                ) { index, question ->
                    QuestionItem(
                        question = question,
