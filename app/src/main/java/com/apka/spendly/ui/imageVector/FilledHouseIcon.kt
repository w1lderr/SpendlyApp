...
val FilledHouseIcon: ImageVector
    get() {
        if (_FilledHouse != null) {
            return _FilledHouse!!
        }
        _FilledHouse = ImageVector.Builder(
            name = "FilledHouse",
            defaultWidth = 28.dp,
            defaultHeight = 28.dp,
            viewportWidth = 28f,
            ...
            path(
                ...
                moveTo(13.28f, 2.641f)
                curveTo(13.707f, 2.32f, 14.293f, 2.32f, 14.72f, 2.641f)
                lineTo(25.12f, 10.442f)
                curveTo(25.422f, 10.669f, 25.6f, 11.024f, 25.6f, 11.402f)
                verticalLineTo(24.399f)
                curveTo(25.6f, 25.062f, 25.063f, 25.6f, 24.4f, 25.6f)
                horizontalLineTo(18.8f)
                verticalLineTo(21.999f)
                curveTo(18.8f, 19.347f, 16.651f, 17.198f, 14f, 17.198f)
                curveTo(11.349f, 17.198f, 9.2f, 19.347f, 9.2f, 21.999f)
                verticalLineTo(25.6f)
                horizontalLineTo(3.6f)
                curveTo(2.937f, 25.6f, 2.4f, 25.062f, 2.4f, 24.399f)
                verticalLineTo(11.402f)
                curveTo(2.4f, 11.024f, 2.578f, 10.669f, 2.88f, 10.442f)
                lineTo(13.28f, 2.641f)
                close()
            }
        }.build()
...
private var _FilledHouse: ImageVector? = null
