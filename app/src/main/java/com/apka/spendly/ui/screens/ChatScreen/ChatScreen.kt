    ...
    Column(
        ...
        if (uiState.value.messages.isNotEmpty()) {
            ...
            LazyColumn(
                ...
                horizontalAlignment = Alignment.Start  // This forces ALL items to align left
            ) {
            ...
            LazyRow(
                ...
                itemsIndexed(
                    listOf(
                        "На що я витрачаю найбільше грошей цього місяця?",
                        "Які категорії витрат можна скоротити без шкоди для комфорту?",
                        "Як мої витрати цього місяця відрізняються від попереднього?",
                        "Яку суму я реально можу відкладати щомісяця, враховуючи мої транзакції?",
                        "Які витрати зростають найшвидше?"
                    )
                ) { index, question ->
                    QuestionItem(
                        question = question,
                ...
                Row(
                    ...
                    TextField(
                        ...
                        colors = TextFieldDefaults.colors(
                            ...
                            disabledPlaceholderColor = Color(0xFFB8B8B8),
